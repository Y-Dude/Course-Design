...
IplImage *quw(IplImage *src, int block, double w)
{
	...
	//保存暗原色先验的图像
	cvSaveImage("C:/Users/lenovo/Desktop/临时文件/OpenCV/图片色相饱和度亮度/图片色相饱和度亮度/dark_channel_prior3.jpg", dark_channel);
	...
	cvSaveImage("C:/Users/lenovo/Desktop/临时文件/OpenCV/图片色相饱和度亮度/图片色相饱和度亮度/toushelv3.jpg", toushelv);
	...
	cvSaveImage("C:/Users/lenovo/Desktop/临时文件/OpenCV/图片色相饱和度亮度/图片色相饱和度亮度/removed_haze3.jpg", dst);
